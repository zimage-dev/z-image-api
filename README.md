...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/tongyi/z-image-turbo?utm_source=github&utm_medium=ugc&utm_campaign=zimage-dev&utm_content=readme-badge&utm_term=tier-a)
...
> **Try it now:** [https://synexa.ai/explore/tongyi/z-image-turbo](https://synexa.ai/explore/tongyi/z-image-turbo?utm_source=github&utm_medium=ugc&utm_campaign=zimage-dev&utm_content=readme-top&utm_term=tier-a) — the hosted model behind this client. New accounts get a free trial credit.
...
Then set your API key (create one at [synexa.ai](https://synexa.ai?utm_source=github&utm_medium=ugc&utm_campaign=zimage-dev&utm_content=readme-apikey&utm_term=tier-a)):
...
|---|---|---|---|
| [`tongyi/z-image-turbo`](https://synexa.ai/explore/tongyi/z-image-turbo?utm_source=github&utm_medium=ugc&utm_campaign=zimage-dev&utm_content=readme-models&utm_term=tier-a) | text-to-image | Z-Image Turbo is a super fast text-to-image model of 6B parameters developed by Tongyi-MAI. | $0.002 |
